...
GRANT ALL PRIVILEGES ON DATABASE edu_platform_db TO postgres;
...
-- Вставка данных
INSERT INTO users (first_name, last_name, email, hashed_password, role, is_active) VALUES
...
INSERT INTO groups (number) VALUES ('ГРУЗ-200');

INSERT INTO teachers (user_id, position) VALUES (1, 'Профессор');

INSERT INTO students (user_id, group_id) VALUES (2, 1);

INSERT INTO subjects (name, type, teacher_id) VALUES ('Работа с данными', 'practice', 1);

INSERT INTO group_subject (group_id, subject_id) VALUES (1, 1);

INSERT INTO course_materials (title, file_path, type, deadline, subject_id, group_id) VALUES
